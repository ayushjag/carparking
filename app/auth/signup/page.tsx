        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <RadioGroup value={role} onValueChange={(value) => setRole(value as 'driver' | 'owner')}>
                <div className="flex items-center space-x-2 border rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                  ...
                  <Label htmlFor="driver" className="flex items-center cursor-pointer flex-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Book parking spots as a driver</p>
                    </div>
                  </Label>
                </div>
                <div className="flex items-center space-x-2 border rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                  <RadioGroupItem value="owner" id="owner" />
                  <Label htmlFor="owner" className="flex items-center cursor-pointer flex-1">
                    <Building className="h-5 w-5 mr-3 text-green-600" />
                    <div>
                      <p className="font-medium">List Parking</p>
                      <p className="text-xs text-gray-500">Rent out parking spaces as an owner</p>
                    </div>
                  </Label>
                </div>
              </RadioGroup>
